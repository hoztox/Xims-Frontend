    ...
    return (
        <div className="bg-[#1C1C24] rounded-lg text-white p-5">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button className="bg-transparent border border-[#10B8FF] text-[#10B8FF] rounded-[4px] p-[10px] flex items-center justify-center gap-[10px] transition-all duration-200 w-[140px] h-[42px] add-policy-btn hover:bg-[#10B8FF] hover:text-white group"
                    onClick={handleAddEnmspolicy}
                >
