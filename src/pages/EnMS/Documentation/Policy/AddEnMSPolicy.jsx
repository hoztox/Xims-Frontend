    ...
    const navigate = useNavigate();
      ...
      const updateActiveStyles = () => {
        ...
        const ColorPickerPanel = ({ onColorSelect, activeColor }) => {
          ...
          return (
            <div
              className="absolute z-20 mt-2 p-3 bg-gray-800 border border-gray-700 rounded-md shadow-lg "
              ref={colorPickerRef}
            >
      ...
      const ColorPickerPanel = ({ onColorSelect, activeColor }) => {
        ...
        return (
          <div
            className="absolute z-20 mt-2 p-3 bg-gray-800 border border-gray-700 rounded-md shadow-lg right-0"
            ref={colorPickerRef}
          >
            <div className="grid grid-cols-5 gap-2 mb-3">
              {colorPalette.map((color, index) => (
  ...
  return (
    <div className="w-full bg-[#1C1C24] rounded-lg p-5 text-white">
          ...
          <div className="flex flex-wrap rounded-[4px] items-center justify-between mb-4 bg-[#24242D] px-5 py-[13px]">
            <ToolbarButton
              icon={<img src={bold} alt="Bold" className="w-3" />}
              command="bold"
              active={activeStyles.bold}
              tooltip="Bold"
            />
            <ToolbarButton
              icon={<img src={itallic} alt="Itallic" className="w-[7px] " />}
              command="italic"
            ...
            <ToolbarButton
              icon={
                <img src={underlines} alt="Underline" className="w-3 mt-[1px]" />
              }
              command="underline"
