...
const AmsManual = () => {
    ...
    const handleAMSAddManual = () => {
        navigate('/company/ams/addmanual');
    };
        ...
        <div className="bg-[#1C1C24] list-manual-main">
            <div className="flex items-center justify-between px-[14px] pt-[24px]">
                ...
                <div className="flex space-x-5">
                    ...
                    <button
                        className="flex items-center justify-center add-manual-btn gap-[10px] duration-200 border border-[#DD6B06] text-[#DD6B06] hover:bg-[#DD6B06] hover:text-white"
                        onClick={handleAMSAddManual}
                    >
