...
const QmsManual = () => {
  ...
  const filteredManual = manual.filter(manuals =>
            ...
            {paginatedManual.length > 0 ? (
              paginatedManual.map((manual, index) => (
                <tr key={manual.id} className="border-b border-[#383840] hover:bg-[#1a1a20] cursor-pointer h-[46px]">
                  ...
                  <td className="px-5 add-manual-datas">{manual.section_title}</td>
                  <td className="px-5 add-manual-datas">{manual.section_no}</td>
                  <td className="px-5 add-manual-datas">{manual.approved_by}</td>
