...
const BmsManual = () => {
    ...
    const handleBMSAddManual = () => {
        navigate('/company/bms/addmanual');
    };
        ...
        <div className="bg-[#1C1C24] list-manual-main">
            <div className="flex items-center justify-between px-[14px] pt-[24px]">
                ...
                <div className="flex space-x-5">
                    ...
                    <button
                        className="flex items-center justify-center add-manual-btn gap-[10px] duration-200 border border-[#F310FF] text-[#F310FF] hover:bg-[#F310FF] hover:text-white"
                        onClick={handleBMSAddManual}
                    >
                        <span>Add Manual Sections</span>
                        <img
                            src={plusicon}
                            alt="Add Icon"
                            className="w-[18px] h-[18px] bms-add-plus"
                        />
                    </button>
                </div>
            </div>
